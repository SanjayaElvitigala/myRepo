...
class Simulation_Env:
    ...
    def prepare_outputs(self):
        ...
        for type_of_room in room_type:
            ...
            reward[type_of_room]=self.get_reward(type_of_room,conversion, expected_ROI, expect_total_profit,static_expect_total_profit, room_price, room_cost)
    ...
    def get_reward(self, type_of_room, conversion, expected_ROI, expect_total_profit, static_expect_total_profit, room_price, room_cost):
    #   reward_tracker = 0
