...
def model_comparison_seg(DQN_seg_rl_df,DQN_rl_df, QLearn_rl_df,base_df):
    model_comparison_df=pd.DataFrame(columns=['Room_type',
                                              'DQN_seg_agent_mean_occupancy_Rate','DQN_agent_mean_occupancy_Rate','QLearn_agent_mean_occupancy_Rate','Base_model_mean_occupancy_Rate',
                                              'DQN_seg_agent_mean_profit', 'DQN_agent_mean_profit', 'QLearn_agent_mean_profit', 'Base_model_mean_profit',
                                              'DQN_seg_agent_mean_revenue','DQN_agent_mean_revenue','QLearn_agent_mean_revenue', 'Base_model_mean_revenue',

                                            ])
    for name_room in room_type:
        model_comparison_df.loc[len(model_comparison_df.index)] = [name_room, DQN_seg_rl_df[1][name_room+'_occupancy'].mean(),DQN_rl_df[1][name_room+'_occupancy'].mean(), QLearn_rl_df[1][name_room+'_occupancy'].mean(),  base_df[1][name_room+'_occupancy'].mean(),
                                                     DQN_seg_rl_df[1][name_room+'_profit'].mean(),DQN_rl_df[1][name_room+'_profit'].mean(), QLearn_rl_df[1][name_room+'_profit'].mean(), base_df[1][name_room+'_profit'].mean(),
                                                     DQN_seg_rl_df[1][name_room+'_revenue'].mean(),DQN_rl_df[1][name_room+'_revenue'].mean(), QLearn_rl_df[1][name_room+'_revenue'].mean(), base_df[1][name_room+'_revenue'].mean()]
    model_comparison_df.loc[len(model_comparison_df.index)]=[ 'Total', DQN_seg_rl_df[1]['Occupancy_rate'].mean(),DQN_rl_df[1]['Occupancy_rate'].mean(), QLearn_rl_df[1]['Occupancy_rate'].mean(),base_df[1]['Occupancy_rate'].mean(),
                                                    DQN_seg_rl_df[1]['Profit'].mean(),DQN_rl_df[1]['Profit'].mean(), QLearn_rl_df[1]['Profit'].mean(),base_df[1]['Profit'].mean(),
                                                    DQN_seg_rl_df[1]['Daily_Revenue'].mean(),DQN_rl_df[1]['Daily_Revenue'].mean(), QLearn_rl_df[1]['Daily_Revenue'].mean(), base_df[1]['Daily_Revenue'].mean()]
    model_comparison_df.fillna(0, inplace=True)
    return model_comparison_df
